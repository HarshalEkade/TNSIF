...
private String infoUrl; // URL for additionalinformation about the player
private String flag; // URL or path to the flagrepresenting the player's country
...
public String getBowlingStyle() {
    ...
    return "Player [playerName=" + playerName + ", playerImg=" + playerImg + ", playerAge=" + playerAge + ", playerRole=" + playerRole + ", battinStyle=" + battingStyle + ", bowlingStyle=" + bowlingStyle + ", country=" + country + ", infoUrl=" + infoUrl + ", flag=" + flag + "]";
    }}
